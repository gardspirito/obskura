...
(function($PS) {
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Halogen_Query_HalogenQ = $PS["Halogen.Query.HalogenQ"];                
  var traduk = function (p) {
      var $34 = Data_Maybe.fromMaybe("[...]");
      var $35 = Data_HashMap.lookup(Data_Hashable.hashableString)(p);
      return function ($36) {
          return $34($35($36));
      };
  };
  var htraduk = function (p) {
      var $37 = traduk(p);
      return function ($38) {
          return Halogen_HTML_Core.text($37($38));
      };
  };

  // https://github.com/purescript-halogen/purescript-halogen/blob/v6.1.2/src/Halogen/Query/HalogenM.purs#L229-L234
  var etendStat = function (v) {
      var go = function (v1) {
          if (v1 instanceof Halogen_Query_HalogenM.State) {
              return new Halogen_Query_HalogenM.State(function (stat) {
                  return Data_Functor.mapFlipped(Data_Tuple.functorTuple)(v1.value0(stat.ene))(function (r) {
                      var $5 = {};
                      for (var $6 in stat) {
                          if ({}.hasOwnProperty.call(stat, $6)) {
                              $5[$6] = stat[$6];
                          };
                      };
                      $5.ene = r;
          ...
          if (v1 instanceof Halogen_Query_HalogenM.Unsubscribe) {
              return new Halogen_Query_HalogenM.Unsubscribe(v1.value0, v1.value1);
          };
          if (v1 instanceof Halogen_Query_HalogenM.Lift) {
              return new Halogen_Query_HalogenM.Lift(v1.value0);
          };
          if (v1 instanceof Halogen_Query_HalogenM.ChildQuery) {
              return new Halogen_Query_HalogenM.ChildQuery(v1.value0);
          };
          if (v1 instanceof Halogen_Query_HalogenM.Raise) {
              return new Halogen_Query_HalogenM.Raise(v1.value0, v1.value1);
          };
          if (v1 instanceof Halogen_Query_HalogenM.Par) {
              return new Halogen_Query_HalogenM.Par(Data_Newtype.over()()(Halogen_Query_HalogenM.HalogenAp)(Control_Applicative_Free.hoistFreeAp(etendStat))(v1.value0));
          };
          if (v1 instanceof Halogen_Query_HalogenM.Fork) {
              return new Halogen_Query_HalogenM.Fork(etendStat(v1.value0), v1.value1);
          };
          if (v1 instanceof Halogen_Query_HalogenM.Kill) {
              return new Halogen_Query_HalogenM.Kill(v1.value0, v1.value1);
          };
          if (v1 instanceof Halogen_Query_HalogenM.GetRef) {
              return new Halogen_Query_HalogenM.GetRef(v1.value0, v1.value1);
          };
          throw new Error("Failed pattern match at Datum (line 63, column 8 - line 73, column 29): " + [ v1.constructor.name ]);
      };
      return Control_Monad_Free.hoistFree(go)(v);
  };
  var mkLinKomp = function (kruda) {
      return Halogen_Component.mkComponent({
          render: function (stat) {
              return kruda.render(stat.lin)(stat.ene);
          },
          initialState: function (en) {
              return {
                  ene: kruda.initialState(en.ene),
                  lin: en.lin
              };
          },
          "eval": function (p) {
              return etendStat((function () {
                  if (p instanceof Halogen_Query_HalogenQ.Receive) {
                      return kruda["eval"](new Halogen_Query_HalogenQ.Receive(p.value0.ene, p.value1));
                  };
                  if (p instanceof Halogen_Query_HalogenQ.Initialize) {
                      return kruda["eval"](new Halogen_Query_HalogenQ.Initialize(p.value0));
                  };
                  if (p instanceof Halogen_Query_HalogenQ.Finalize) {
                      return kruda["eval"](new Halogen_Query_HalogenQ.Finalize(p.value0));
                  };
                  if (p instanceof Halogen_Query_HalogenQ.Action) {
                      return kruda["eval"](new Halogen_Query_HalogenQ.Action(p.value0, p.value1));
                  };
                  if (p instanceof Halogen_Query_HalogenQ.Query) {
                      return kruda["eval"](new Halogen_Query_HalogenQ.Query(p.value0, p.value1));
                  };
                  throw new Error("Failed pattern match at Datum (line 46, column 15 - line 51, column 52): " + [ p.constructor.name ]);
              })());
          }
      });
  };
  exports["mkLinKomp"] = mkLinKomp;
  exports["htraduk"] = htraduk;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
...
(function($PS) {
  "use strict";
  $PS["UzantMenu"] = $PS["UzantMenu"] || {};
  var exports = $PS["UzantMenu"];
  var Data_Function = $PS["Data.Function"];
  var Datum = $PS["Datum"];
  var Halogen_Component = $PS["Halogen.Component"];
  ...
  var Aux = (function () {
      ...
      Aux.create = function (value0) {
          return new Aux(value0);
      };
      return Aux;
  })();
  var Sukc = (function () {
  ...
  var proxy = Type_Proxy["Proxy"].value;
  var montr = function (lin) {
      return function (stat) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id("uzant-menu") ])([ (function () {
              if (stat instanceof Aux) {
                  return Halogen_HTML_Elements.div([  ])([ Datum.htraduk("aux.ensalutu")(lin) ]);
              };
              if (stat instanceof Sukc) {
                  return Halogen_HTML_Elements.div([  ])([  ]);
              };
              throw new Error("Failed pattern match at UzantMenu (line 32, column 9 - line 36, column 33): " + [ stat.constructor.name ]);
          })() ]);
      };
  };
  var komp = Datum.mkLinKomp({
      initialState: Data_Function["const"](new Aux({
          retposxt: ""
      })),
      render: montr,
...
(function($PS) {
  ...
  var UzantMenu = $PS["UzantMenu"];                
  var montr = function (v) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id("supr") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id("uzant") ])([ Halogen_HTML.slot_()({
          reflectSymbol: function () {
              return "uzantMenu";
          }
      })(Data_Ord.ordInt)(UzantMenu.proxy)(0)(UzantMenu.komp)({
          lin: v.lin,
          ene: Data_Unit.unit
      }) ]) ]);
  };
  var mapLiv = function (v) {
      return function (v1) {
          if (v1 instanceof Data_Either.Left) {
          ...
          throw new Error("Failed pattern match at Main (line 32, column 1 - line 32, column 61): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var komp = function (lin) {
      return Halogen_Component.mkComponent({
  ...
  var disvolvi = function (dictMonadEffect) {
      return function (dictShow) {
          return function (v) {
              return function (v1) {
                  if (v1 instanceof Data_Either.Left) {
                      return Control_Bind.discard(Control_Bind.discardUnit)((dictMonadEffect.Monad0()).Bind1())(Effect_Class_Console.errorShow(dictMonadEffect)(Data_Show.showString)(v1.value0))(function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 25, column 1 - line 25, column 79): " + [ v.constructor.name, v1.constructor.name ]);
              };
          };
      };
  };
  var petLingv = function (dictMonadAff) {
      return Control_Bind.bind(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Data_Functor.mapFlipped(((((dictMonadAff.MonadEffect0()).Monad0()).Bind1()).Apply0()).Functor0())(Effect_Aff_Class.liftAff(dictMonadAff)(Affjax.get(Affjax_ResponseFormat.json)("/kern/lingvar")))(function (respond) {
          return Control_Bind.bind(Data_Either.bindEither)(mapLiv(Affjax.printError)(respond))(function (korpo) {
              return Control_Bind.bind(Data_Either.bindEither)(mapLiv(Data_Show.show(Data_Argonaut_Decode_Error.showJsonDecodeError))(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonString))(korpo.body)))(function (obj) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(Data_HashMap.fromFoldable(Data_Foldable.foldableArray)(Data_Hashable.hashableString)(Foreign_Object.toArrayWithKey(Data_Tuple.Tuple.create)(obj)));
              });
          });
      }))(disvolvi(dictMonadAff.MonadEffect0())(Data_HashMap.showHashMap(Data_Show.showString)(Data_Show.showString))(Data_HashMap.empty));
  };
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (pagx) {
      return Control_Bind.bind(Effect_Aff.bindAff)(petLingv(Effect_Aff_Class.monadAffAff))(function (lingv) {
          return Halogen_VDom_Driver.runUI(komp(lingv))(Data_Unit.unit)(pagx);
      });
  }));
  exports["main"] = main;
})(PS);
