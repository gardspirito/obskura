...
(function($PS) {
  ...
  var montr = function (v) {
      if (v instanceof Aux) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id("uzant-menu") ])([ Halogen_HTML_Core.text(v.value0.retposxt) ]);
      };
      if (v instanceof Sukc) {
          return Halogen_HTML_Elements.div_([  ]);
      };
      throw new Error("Failed pattern match at UzantMenu (line 25, column 1 - line 25, column 54): " + [ v.constructor.name ]);
  };
  var comp = Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var montr = function (v) {
      ...
      })(Data_Ord.ordInt)(UzantMenu.proxy)(0)(UzantMenu.comp)(Data_Unit.unit) ]) ]);
  };
  var komp = Halogen_Component.mkComponent({
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (pagx) {
      return Halogen_VDom_Driver.runUI(komp)(Data_Unit.unit)(pagx);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();